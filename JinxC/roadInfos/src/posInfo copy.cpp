...
bool getPosInfo::isInSpecialLaneType(Point p, OpenDrive::EnLaneType roadType,OpenDrive::EnAccessRestriction laneAccessRestrictType)
{
    ...
    else 
    {
        ...
        // OpenDrive::Node* mylaneAttr = mylaneNode->getChild();
        // //JUST FOR TEST
        // mylaneNode->printData();
        // std::cout<<mylaneNode->getOpcode()<<std::endl;
        // std::cout<<mylaneAttr->getOpcode()<<std::endl;
        // //JUST FOR TEST
        // while  ((mylaneAttr->getOpcode()!=45)&&(mylaneAttr->getRight()))
        // {
        //     OpenDrive::Node* mylaneAttrnew=mylaneAttr->getRight();
        //     mylaneAttr=mylaneAttrnew;
        //     //JUST FOR TEST
        //     std::cout<<mylaneAttr->getOpcode()<<std::endl;
        //     //JUST FOR TEST
        //     if ((mylaneAttr->getOpcode()==45)||((mylaneAttr->getRight())==NULL))
        //     {
        //         break ;
        //     }
        // }
        // if (mylaneAttr->getOpcode()==45)
        // {
        //     unsigned int myLaneAccessRestrict=0;
        //     OpenDrive::LaneAccess* myLaneAccess=(OpenDrive::LaneAccess*) mylaneAttr;
        //     if (myLaneAccess->mRestriction)
        //     {
        //         myLaneAccessRestrict=myLaneAccess->mRestriction;
        //         //JUST FOR TEST
        //         std::cout<<myLaneAccessRestrict<<std::endl;
        //         //JUST FOR TEST
        ...
        //     }
        // }
        // if ((mylaneAttr->getRight())==NULL)
        // {
        //     std::cout<<"There has no Access Restrict"<<std::endl;
        // }

        std::cout<<mylaneNode->getOpcode()<<std::endl;
        std::cout<<mylaneNode->getChild(45)->getOpcode()<<std::endl;
...
bool getPosInfo::isInSce2_46_7(Point p)
{
    ...
    if (isInRoad)
    {
        ...
        OpenDrive::Position*  pos1 = Manager.createPosition();
        Manager.activatePosition(pos1);
        Manager.setLanePos(m_posInfo.roadId, m_posInfo.laneId, 0.1);
        ...
        myManager.setLanePos(m_posInfo.roadId, pos_info1.lane->mId, slength-0.1);
