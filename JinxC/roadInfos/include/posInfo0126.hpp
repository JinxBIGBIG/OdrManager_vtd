...
public:
  ...
  int isInBackLane(Point p1, Point p2 ,float heading1) ;

  int isInFrontLane(Point p1, Point p2 ,float heading1) ;

  //  int drivingDirRelToRoad(bool isRHT);

  // int isInSameLane(Point p1, Point p2, bool isInFront);

  bool isBackCar(Point p1, Point p2,float heading1,float heading2) ;

  bool isFrontCar(Point p1, Point p2,float heading1,float heading2) ;
