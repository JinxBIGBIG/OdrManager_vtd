...
public:
  ...
  bool isInSec2_46_6(Point p1,Point p2,Point p3,float heading1,float heading2,float heading3);
  ...
  bool isInSec3_6_6(Point p,float vehicleSpeed,int vehicleType,Point p2);
