...
class OdrManagerLite
{
    public:
        ...
        */
        ...
        /**
        * default constructor
        * @param flags used for VIRES internal purposes
        */
        ...
        */
        ...
        /**
        * member access function
        *   @param value set the track co-ordinate
        */
        ...
        */
        ...
        /**
        * member access function
        *   @param value set the lane co-ordinate
        */
        ...
        */
        ...
        /**
        * member access function
        *   @param value set the inertial co-ordinate
        */
    ...
    protected:
        ...
        */
        ...
        /**
        * remember whether this instance is attached only and must not delete road
        * data upon exiting
        * @version 1.4.5
        */
        bool mAttachedOnly;
